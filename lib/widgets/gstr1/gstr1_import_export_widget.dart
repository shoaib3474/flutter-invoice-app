...
class GSTR1ImportExportWidget extends StatefulWidget {
  ...
  @override
  _GSTR1ImportExportWidgetState createState() => _GSTR1ImportExportWidgetState();
}
...
class _GSTR1ImportExportWidgetState extends State<GSTR1ImportExportWidget> {
  ...
  Future<void> _exportGSTR1(GSTR1Model data) async {
    ...
    try {
      ...
      final fileName = 'GSTR1_${data.gstin}_${data.returnPeriod?.replaceAll(' ', '_')}.json';
                  ...
                  children: [
                    ...
                    FutureBuilder<List<GSTR1Model>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        if (returns.isEmpty) {
                          return const Text('No GSTR-1 returns available for export.');
                        }
                          ...
                          children: [
                            ...
                            ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return ListTile(
                                  title: Text('${returnData.gstin} - ${returnData.returnPeriod}'),
                                  subtitle: Text('Financial Year: ${returnData.financialYear}'),
        ...
        child: Column(
          ...
          children: [
            ...
            if (_previewData != null) ...[
              ...
              _buildPreviewInfo('Financial Year', _previewData!.financialYear ?? 'N/A'),
              _buildPreviewInfo('Tax Period', _previewData!.returnPeriod ?? 'N/A'),
              _buildPreviewInfo('B2B Invoices', _previewData!.b2bInvoices.length.toString()),
              _buildPreviewInfo('B2C Large Invoices', _previewData!.b2clInvoices.length.toString()),
              _buildPreviewInfo('B2C Small Invoices', _previewData!.b2csInvoices.length.toString()),
              _buildPreviewInfo('HSN Summary Items', _previewData!.hsnSummary.length.toString()),
              const SizedBox(height: 16),
              Row(
