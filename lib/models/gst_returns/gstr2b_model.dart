...
class GSTR2B {
  ...
  factory GSTR2B.fromJson(Map<String, dynamic> json) => _$GSTR2BFromJson(json);
  Map<String, dynamic> toJson() => _$GSTR2BToJson(this);
}
...
class GSTR2BSummary {
  ...
  factory GSTR2BSummary.fromJson(Map<String, dynamic> json) => _$GSTR2BSummaryFromJson(json);
  Map<String, dynamic> toJson() => _$GSTR2BSummaryToJson(this);
}
...
class B2BInvoice {
  ...
  final String eligibilityType; // Eligible, Ineligible, Blocked
