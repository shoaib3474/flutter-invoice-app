...
class BuildHelper {
  ...
  Future<ProcessResult> executeCommand(String command, List<String> arguments) async {
  ...
  Future<String?> buildOptimizedApk() async {
    try {
      ...
      final String outputPath = '${appDocDir.path}/flutter_invoice_app_$appVersion.apk';
      
      // Copy the APK to the output directory
      final File apkFile = File('build/app/outputs/flutter-apk/app-arm64-v8a-release.apk');
