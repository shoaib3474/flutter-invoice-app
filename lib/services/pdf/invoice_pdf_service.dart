...
class InvoicePdfService {
  ...
  Future<Uint8List> generateInvoicePdf(Invoice invoice) async {
    ...
    pdf.addPage(
      pw.MultiPage(
        ...
        header: (context) => _buildHeader(invoice, logoImage, boldFont, dateFormat),
        ...
        build: (context) => [
          ...
          if (invoice.notes.isNotEmpty) ...[
            pw.Text('Notes:', style: pw.TextStyle(font: boldFont, fontSize: 12)),
          ...
          if (invoice.termsAndConditions.isNotEmpty) ...[
            pw.Text('Terms and Conditions:', style: pw.TextStyle(font: boldFont, fontSize: 12)),
            pw.SizedBox(height: 5),
            pw.Text(invoice.termsAndConditions, style: pw.TextStyle(font: font, fontSize: 10)),
            pw.SizedBox(height: 20),
          ],
          ...
          pw.Container(
            ...
            child: pw.Column(
              ...
              children: [
                pw.Text('GST Declaration:', style: pw.TextStyle(font: boldFont, fontSize: 10)),
                pw.SizedBox(height: 5),
                pw.Text(
          ...
          pw.Row(
            ...
            children: [
              pw.Column(
                crossAxisAlignment: pw.CrossAxisAlignment.start,
                children: [
                  pw.Text('Receiver\'s Signature', style: pw.TextStyle(font: boldFont, fontSize: 10)),
                  pw.SizedBox(height: 20),
                  pw.Container(
                    width: 150,
                    height: 1,
              ...
              pw.Column(
                ...
                children: [
                  pw.Text('For ${invoice.customerName}', style: pw.TextStyle(font: boldFont, fontSize: 10)),
                  pw.SizedBox(height: 20),
                  pw.Container(
                    width: 150,
                    height: 1,
  ...
  pw.Widget _buildHeader(Invoice invoice, pw.MemoryImage? logoImage, pw.Font boldFont, DateFormat dateFormat) {
          ...
          children: [
            if (logoImage != null)
              ...
              pw.Container(
                ...
                child: pw.Text('LOGO', style: pw.TextStyle(font: boldFont, color: PdfColors.grey)),
              ),
            pw.Column(
              crossAxisAlignment: pw.CrossAxisAlignment.end,
              children: [
                pw.Text(invoiceTypeText, style: pw.TextStyle(font: boldFont, fontSize: 16)),
                pw.SizedBox(height: 5),
                pw.Text('Invoice #: ${invoice.invoiceNumber}', style: pw.TextStyle(font: boldFont, fontSize: 14)),
                pw.SizedBox(height: 5),
                pw.Text('Date: ${dateFormat.format(invoice.invoiceDate)}', style: pw.TextStyle(font: boldFont, fontSize: 12)),
                pw.SizedBox(height: 5),
                pw.Text('Due Date: ${dateFormat.format(invoice.dueDate)}', style: pw.TextStyle(font: boldFont, fontSize: 12)),
              ],
            ),
          ],
        ),
          ...
          children: [
            pw.Expanded(
              child: pw.Column(
                crossAxisAlignment: pw.CrossAxisAlignment.start,
                children: [
                  pw.Text('123 Business Street, Area Name', style: pw.TextStyle(font: boldFont, fontSize: 10)),
                  pw.Text('City, State - PIN Code', style: pw.TextStyle(font: boldFont, fontSize: 10)),
                  pw.Text('GSTIN: 27AADCB2230M1ZP', style: pw.TextStyle(font: boldFont, fontSize: 10)),
                  pw.Text('PAN: AADCB2230M', style: pw.TextStyle(font: boldFont, fontSize: 10)),
                  pw.Text('Email: contact@yourcompany.com', style: pw.TextStyle(font: boldFont, fontSize: 10)),
                  pw.Text('Phone: +91 9876543210', style: pw.TextStyle(font: boldFont, fontSize: 10)),
                ],
              ),
            ),
            if (invoice.isReverseCharge)
              pw.Container(
                ...
                child: pw.Text('Reverse Charge: Yes', style: pw.TextStyle(font: boldFont, fontSize: 10, color: PdfColors.red)),
              ),
          ],
        ),
          ...
          child: pw.Container(
            ...
            child: pw.Column(
              ...
              children: [
                ...
                pw.SizedBox(height: 5),
                pw.Text(invoice.customerName, style: pw.TextStyle(font: boldFont, fontSize: 11)),
                pw.SizedBox(height: 2),
                pw.Text(invoice.customerAddress, style: pw.TextStyle(font: font, fontSize: 10)),
                pw.SizedBox(height: 2),
                pw.Text('State: ${invoice.customerState} (${invoice.customerStateCode})', style: pw.TextStyle(font: font, fontSize: 10)),
                if (invoice.customerGstin.isNotEmpty) ...[
                  pw.SizedBox(height: 2),
                  pw.Text('GSTIN: ${invoice.customerGstin}', style: pw.TextStyle(font: boldFont, fontSize: 10)),
                ],
              ],
            ),
          ),
        ...
        pw.Expanded(
          child: pw.Container(
            ...
            child: pw.Column(
              crossAxisAlignment: pw.CrossAxisAlignment.start,
              children: [
                pw.Text('Ship To:', style: pw.TextStyle(font: boldFont, fontSize: 12)),
                pw.SizedBox(height: 5),
                pw.Text(invoice.customerName, style: pw.TextStyle(font: boldFont, fontSize: 11)),
                pw.SizedBox(height: 2),
                pw.Text(invoice.customerAddress, style: pw.TextStyle(font: font, fontSize: 10)),
                ...
                pw.SizedBox(height: 2),
                if (invoice.isB2B) ...[
                  pw.Text('Supply Type: B2B', style: pw.TextStyle(font: font, fontSize: 10)),
                ] else ...[
                  pw.Text('Supply Type: B2C', style: pw.TextStyle(font: font, fontSize: 10)),
                ],
                pw.SizedBox(height: 2),
                if (invoice.isInterState) ...[
                  pw.Text('Interstate Supply', style: pw.TextStyle(font: font, fontSize: 10)),
                ] else ...[
                  pw.Text('Intrastate Supply', style: pw.TextStyle(font: font, fontSize: 10)),
                ],
              ],
            ),
          ),
      ...
      children: [
        ...
        ...invoice.items.map((item) {
          ...
          if (invoice.isInterState) {
            ...
            taxAmountText = 'CGST: ₹${NumberFormatter.format(item.cgstAmount)}\nSGST: ₹${NumberFormatter.format(item.sgstAmount)}';
          }
            ...
            children: [
              ...
              pw.Padding(
                ...
                child: pw.Column(
                  crossAxisAlignment: pw.CrossAxisAlignment.start,
                  children: [
                    pw.Text(item.name, style: pw.TextStyle(font: boldFont, fontSize: 10)),
                    if (item.description.isNotEmpty)
                      pw.Text(item.description, style: pw.TextStyle(font: font, fontSize: 8)),
                  ],
                ),
              ),
  ...
  pw.Widget _buildInvoiceSummary(Invoice invoice, pw.Font font, pw.Font boldFont) {
    return pw.Row(
      crossAxisAlignment: pw.CrossAxisAlignment.start,
      children: [
        ...
        pw.Expanded(
          ...
          child: pw.Container(
            ...
            child: pw.Column(
              crossAxisAlignment: pw.CrossAxisAlignment.start,
              children: [
                pw.Text('HSN/SAC Summary', style: pw.TextStyle(font: boldFont, fontSize: 10)),
                pw.SizedBox(height: 5),
                // In a real app, you would generate HSN/SAC summary here
                pw.Text('HSN/SAC summary would appear here', style: pw.TextStyle(font: font, fontSize: 9, color: PdfColors.grey700)),
              ],
            ),
          ),
        ),
              ...
              children: [
                pw.Row(
                  ...
                  children: [
                    ...
                    pw.Text('₹${NumberFormatter.format(invoice.subtotal)}', style: pw.TextStyle(font: font, fontSize: 10)),
                  ],
                ),
                pw.SizedBox(height: 5),
                ...
                if (invoice.isInterState) ...[
                  pw.Row(
                    mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                    children: [
                      pw.Text('IGST:', style: pw.TextStyle(font: font, fontSize: 10)),
                      pw.Text('₹${NumberFormatter.format(invoice.igstTotal)}', style: pw.TextStyle(font: font, fontSize: 10)),
                    ],
                  ),
                ] else ...[
                  pw.Row(
                    mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                    children: [
                      pw.Text('CGST:', style: pw.TextStyle(font: font, fontSize: 10)),
                      pw.Text('₹${NumberFormatter.format(invoice.cgstTotal)}', style: pw.TextStyle(font: font, fontSize: 10)),
                    ],
                  ),
                  pw.SizedBox(height: 5),
                  pw.Row(
                    mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                    children: [
                      pw.Text('SGST:', style: pw.TextStyle(font: font, fontSize: 10)),
                      pw.Text('₹${NumberFormatter.format(invoice.sgstTotal)}', style: pw.TextStyle(font: font, fontSize: 10)),
                    ],
                  ),
                ],
                ...
                if (invoice.cessTotal > 0) ...[
                  ...
                  pw.Row(
                    mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                    children: [
                      pw.Text('Cess:', style: pw.TextStyle(font: font, fontSize: 10)),
                      pw.Text('₹${NumberFormatter.format(invoice.cessTotal)}', style: pw.TextStyle(font: font, fontSize: 10)),
                    ],
                  ),
                ],
                ...
                pw.Row(
                  mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                  children: [
                    pw.Text('Total Tax:', style: pw.TextStyle(font: font, fontSize: 10)),
                    pw.Text('₹${NumberFormatter.format(invoice.totalTax)}', style: pw.TextStyle(font: font, fontSize: 10)),
                  ],
                ),
                pw.SizedBox(height: 5),
                pw.Container(
                  ...
                  child: pw.Row(
                    mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                    children: [
                      pw.Text('Grand Total:', style: pw.TextStyle(font: boldFont, fontSize: 12)),
                      pw.Text('₹${NumberFormatter.format(invoice.grandTotal)}', style: pw.TextStyle(font: boldFont, fontSize: 12)),
                    ],
                  ),
                ),
                pw.SizedBox(height: 10),
    ...
    return pw.Column(
      ...
      children: [
        ...
        pw.Row(
          mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
          children: [
            pw.Text('E. & O.E. This is a computer-generated invoice, no signature required.',
  ...
  Future<void> shareInvoicePdf(Invoice invoice) async {
    ...
    final file = File('${output.path}/$fileName');
    await file.writeAsBytes(pdfData);
    await Share.shareXFiles([XFile(file.path)], text: 'Sharing invoice ${invoice.invoiceNumber}');
  }
