...
class _ExportDemoScreenState extends State<ExportDemoScreen> {
  ...
  Future<void> _loadDemoData() async {
    ...
    try {
      ...
      final reconciliationResult = await _demoService.generateDemoReconciliationResult();
                ...
                children: [
                  ...
                  if (_gstr1 != null)
                    ExportOptionsWidget(
                      title: 'GSTR-1 Export',
                      data: _gstr1!,
                      fileName: 'GSTR1_${_gstr1!.gstin}_${_gstr1!.returnPeriod.replaceAll(' ', '_')}',
                      onExport: (exportType) => _handleExport(exportType, 'gstr1'),
                    ),
                  ...
                  if (_gstr3b != null)
                    ExportOptionsWidget(
                      ...
                      data: _gstr3b!,
                      fileName: 'GSTR3B_${_gstr3b!.gstin}_${_gstr3b!.returnPeriod.replaceAll(' ', '_')}',
                      onExport: (exportType) => _handleExport(exportType, 'gstr3b'),
                    ),
                  ...
                  if (_reconciliationResult != null)
                    ExportOptionsWidget(
                      ...
                      fileName: 'Reconciliation_Report_${DateTime.now().toString().substring(0, 10).replaceAll('-', '_')}',
                      onExport: (exportType) => _handleExport(exportType, 'reconciliation'),
                    ),
                ],
              ),
            ),
  ...
  Future<void> _handlePdfExport(String dataType) async {
    ...
    switch (dataType) {
      case 'gstr1':
        ...
        fileName = 'GSTR1_${_gstr1!.gstin}_${_gstr1!.returnPeriod.replaceAll(' ', '_')}.pdf';
        break;
      case 'gstr3b':
        pdfData = await _pdfService.generateGstr3bPdf(_gstr3b!);
        fileName = 'GSTR3B_${_gstr3b!.gstin}_${_gstr3b!.returnPeriod.replaceAll(' ', '_')}.pdf';
        break;
      case 'reconciliation':
        pdfData = await _pdfService.generateReconciliationPdf(_reconciliationResult!);
        fileName = 'Reconciliation_Report_${DateTime.now().toString().substring(0, 10).replaceAll('-', '_')}.pdf';
        break;
    }
  ...
  Future<void> _handleExcelExport(String dataType) async {
    ...
    switch (dataType) {
      case 'gstr1':
        ...
        fileName = 'GSTR1_${_gstr1!.gstin}_${_gstr1!.returnPeriod.replaceAll(' ', '_')}.xlsx';
        break;
      case 'gstr3b':
        excelData = await _excelService.generateGstr3bExcel(_gstr3b!);
        fileName = 'GSTR3B_${_gstr3b!.gstin}_${_gstr3b!.returnPeriod.replaceAll(' ', '_')}.xlsx';
        break;
      case 'reconciliation':
        excelData = await _excelService.generateReconciliationExcel(_reconciliationResult!);
        fileName = 'Reconciliation_Report_${DateTime.now().toString().substring(0, 10).replaceAll('-', '_')}.xlsx';
        break;
    }
  ...
  Future<void> _handleJsonExport(String dataType) async {
    ...
    switch (dataType) {
      case 'gstr1':
        data = _gstr1!;
        fileName = 'GSTR1_${_gstr1!.gstin}_${_gstr1!.returnPeriod.replaceAll(' ', '_')}.json';
        break;
      case 'gstr3b':
        data = _gstr3b!;
        fileName = 'GSTR3B_${_gstr3b!.gstin}_${_gstr3b!.returnPeriod.replaceAll(' ', '_')}.json';
        break;
      case 'reconciliation':
        data = _reconciliationResult!;
        fileName = 'Reconciliation_Report_${DateTime.now().toString().substring(0, 10).replaceAll('-', '_')}.json';
        break;
    }
