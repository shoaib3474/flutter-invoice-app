...
import '../test/document_scanner_test_screen.dart';
import '../test/stripe_config_test_screen.dart';
...
class TestScreensMenuScreen extends StatelessWidget {
            ...
            [
              TestScreenItem(
                ...
                onTap: () => Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => const DocumentScannerTestScreen(),
                  ),
                ),
                status: TestStatus.ready,
              ),
            ...
            [
              TestScreenItem(
                ...
                onTap: () => Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => const StripeConfigTestScreen(),
                  ),
                ),
                status: TestStatus.ready,
              ),
  ...
  Widget _buildTestItem(BuildContext context, TestScreenItem item, Color color) {
    return ListTile(
