...
//                 Row(
//                   children: [
//                     Icon(Icons.home_mini_outlined, color: Colors.orange.shade700),
//                     const SizedBox(width: 8),
//                     Text(
...
//     this.recommendation,
//     this.fixCommand, required int totalTests, required int passedTests, required int failedTests, required Map<String, String> errors, required Map results,
//   });
// }
